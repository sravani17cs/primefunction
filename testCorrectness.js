+/* eslint-env mocha, chai */
    ...
    describe('Test for Correction', function () {
      describe('primGen', function () {
        it('primGen(10) => [2, 3, 5, 7]', function () {
          chai.expect(primGen(10)).to.have.members([2, 3, 5, 7]);
        });
        it('primeGen(20) => [2, 3, 5, 7, 11, 13, 17, 19]', function () {
          chai.expect(primGen(20)).to.have.members([2, 3, 5, 7, 11, 13, 17, 19]);
        });
      });
